...
import com.isa.morswiny.users.UserTypes;
...
public class UserRepository {
    ...
    private static void fillRepositoryWithAdmins() {
        ...
        user1.setUserTypes(UserTypes.ADMIN);
        ...
        user2.setUserTypes(UserTypes.ADMIN);
        ...
        user3.setUserTypes(UserTypes.ADMIN);
        ...
        user4.setUserTypes(UserTypes.ADMIN);
        ...
        user5.setUserTypes(UserTypes.ADMIN);
